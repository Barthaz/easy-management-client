...
const Navbar = () => {
  const { activeMenu, setActiveMenu, user, isClicked, setIsClicked, handleClick, screenSize, setScreenSize} = useStateContext();
    ...
    <div className="flex justify-between p-2 md:mx-6 relative">
      ...
      <div className="flex">
        ...
        <TooltipComponent content="Profile" position="BottomCenter">
          <div className="flex items-center gap-2 cursor-pointer p-1 hover:bg-light-gray roundewd-lg" onClick={() => (handleClick('userProfile'))}>
